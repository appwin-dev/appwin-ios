...
extension AppwinCore {
  ...
  public static func identify(externalId: String, attributes: AppwinUserAttributes? = nil) async throws {
    ...
    // A change of identity revokes the previous push binding server-side.
    // Replay on retries too: a successful session bootstrap can precede a failed registration.
