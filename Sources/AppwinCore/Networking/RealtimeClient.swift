...
public actor RealtimeClient {
  ...
  public struct Config: Sendable {
    ...
    public init(
      ...
      // Close quickly so Support push is not skipped while the app is backgrounded
      // (server skips push when the SDK realtime presence is still active).
      backgroundTimeout: TimeInterval = 1,
