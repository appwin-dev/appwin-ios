...
private struct UnconfiguredCommunityRepository: CommunityRepository {
    ...
    func createPost(
        ...
        pollOptions: [String]?
    ) async throws -> CommunityPost { throw error }
    func updatePost(
        postId: String,
        body: String?,
        groupId: String?,
    ...
    func voteOnPoll(postId: String, optionId: String) async throws -> CommunityPoll { throw error }
    func comments(postId: String, limit: Int, offset: Int) async throws -> [CommunityComment] { throw error }
    func createComment(postId: String, body: String, parentCommentId: String?, media: [CommunityMedia]) async throws -> CommunityComment { throw error }
    ...
    func uploadMedia(
        ...
        width: Int?,
        height: Int?
    ) async throws -> CommunityUploadedMedia { throw error }
    func report(
        targetType: String,
        targetId: String,
