...
struct AppwinAvatar: View {
    ...
    /// First two letters of the name, uppercased. Empty when there is no
    /// name: anonymous customers have none since the "Visitor" placeholder
    /// was dropped, and a "?" read as an error rather than an empty state.
