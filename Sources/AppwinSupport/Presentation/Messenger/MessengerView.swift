...
struct MessengerView: View {
  ...
  private var title: String {
    configStore.config.context.agentName
  }
  
  
  
  /// Assembles the components: list in the middle, composer at the bottom,
  /// header in the native toolbar.
  private var content: some View {
    ...
    .toolbarBackground(AppwinTokens.surface, for: .navigationBar)
    ...
    .background(AppwinTokens.surface.ignoresSafeArea())
  }
}
