...
//  AppwinSupport
//
//  Message area: white background, 24 gap, day separators.
...
struct MessageList: View {
    ...
    private var listItems: [MessageListItem] {
        MessageDayGrouping.items(from: store.messages)
    }
                        ...
                        LazyVStack(spacing: 24) {
                            ...
                            ForEach(listItems) { item in
                                ...
                                case .message(let message, let groupMeta):
                                    ...
                                    // Include the body in the id, to force a
                                    // realtime redraw after an edit.
